<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="productList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="总数" align="center" prop="total"  width="40"/>
    ...
    <el-dialog :title="title" :visible.sync="openInput" width="500px" append-to-body>
      <el-form ref="formInput" :model="formInput" :rules="rules" label-width="80px">
    ...
    <el-dialog :title="title" :visible.sync="openOutput" width="500px" append-to-body>
      <el-form ref="formOutput" :model="formOutput" :rules="rules" label-width="80px">
        <el-table
          :data="productStroe"
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              ...
              <el-input v-else v-model="scope.row.outputCount" 
               @change="handleOuptCountEdit(scope.$index, scope.row)"></el-input>
            </template>
          </el-table-column>
        </el-table>
      </el-form>
...
<script>
import { listProduct, getProduct, delProduct, addProduct, updateProduct, getProductStore } from "@/api/system/product";
