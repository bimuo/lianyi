<template>
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="openOutput" width="500px" append-to-body>
      <el-form ref="formOutput" :model="formInput" :rules="rules" label-width="80px">
        <el-form-item label="货架" prop="shelves">
          
        </el-form-item>
        <el-form-item label="数量" prop="count">
          <el-input v-model.number="formOutput.count" placeholder="请输入数量" />
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="submitFormInput">出 库</el-button>
        <el-button @click="cancel">取 消</el-button>
      </div>
    </el-dialog>
  </div>
